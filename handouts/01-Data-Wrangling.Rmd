...
Hint: for charactesr such as CONTROL, you will need to use "CONTROL" instead of CONTROL
:::
...
* `value`: he column you want to use to populate the new columns (the `value` column we just created in the spread step)
